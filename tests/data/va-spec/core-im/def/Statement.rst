...
A Statement (aka "Assertion") represents a claim of purported truth as made by a particular agent, on a particular occasion. In addition to the properties shared by all Statements, statements MUST also have properties inheriting from Subject<ref> and Predicate<ref>, MAY also have a property inheriting from Object<ref> and MAY also have one or more properties inheriting from Qualifier<ref>.
