...
from ga4gh.gks.metaschema.tools.release_prep.product_config import update_product_version


def test_update_product_version_replaces_config_without_leaving_temp_files(tmp_path: Path) -> None:
